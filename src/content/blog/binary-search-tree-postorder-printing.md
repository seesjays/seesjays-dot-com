...
title: "Binary Search Tree (Postorder Printing)"
subtext: "Binary Search Tree (Postorder Printing) written in C++"
sector: extras
date: "2022-01-01"
---
...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Binary Search Tree Postorder Test" << std::endl;
