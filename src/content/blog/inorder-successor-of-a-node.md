...
title: "Inorder Successor of a Node"
subtext: "Inorder Successor of a Node written in C++"
sector: extras
date: "2022-01-01"
---
...
public:
    ...
    TreeNode *getInOrderSuccessor(TreeNode *parent);
...
TreeNode *BinaryTree::getInOrderSuccessor(TreeNode *parent)
{
...
int main(int argc, char *argv[])
{
    ...
    TreeNode *successor = test.getInOrderSuccessor(test.getRoot()->right);
    std::cout << "successor of " << test.getRoot()->value << ": " << successor->value << std::endl;
