...
title: "I Hope Web Push Doesn't Suck"
date: "2022-07-16"
subtext: "Web Push might be good, might be bad."
sector: me
---
...
For the untechnical among us, since you may not know:
On iOS, [Push Notifications](https://support.apple.com/en-us/HT201925) as a feature have been limited to the kind of apps you would download from the App Store since their inception.

[Android](https://developer.android.com/guide/topics/ui/notifiers/notifications) doesn’t have this limitation, instead the system opts to allow apps **and websites** to send notifications directly to your devices.

The removal of that Safari limitation has been pined for by developers for _ages._

## The Ever-Increasing Value of Attention

With the arrival of iOS 16, the iPhones and iPads of the world will [Meet Web Push,](https://webkit.org/blog/12945/meet-web-push/) changing the metaphorical app game forever.
...
> My pet theory is that Discord withstood the massive controversy they faced from [brightening their iconic brand color](https://support.discord.com/hc/en-us/articles/1500009438682-A-Fresh-New-Look-to-Celebrate-Our-6th-Birthday) to capture more attention on home screens, in competition with already brightly-colored social apps like Twitter, Reddit, and Snapchat.
>
> > My theory is further proven by Instagram doing the [exact same thing](https://about.instagram.com/blog/announcements/instagram-visual-refresh) a year later.
...
There’s never truly a “peak noise” either, just advances in ways of making the noise noisier. Optimization, [Dark Patterns,](https://www.vox.com/recode/22351108/dark-patterns-ui-web-design-privacy) and abusing human psychology means there will never be a real end, not `till they’re [in our dreams.](https://www.youtube.com/watch?v=XPGgTy5YJ-g)
...
What’s shocked me is how much raw _effort_ it takes to do so: receiving a notification of some fresh spam entering my inbox, opening the spam, and then going through whatever unsubscribe process they have, cursing it all in my head, then getting back on track with whatever I was doing before. It’s a tedious pattern, and I have been making good headway. But really, was email _supposed_ to be like this?
...
I feel that as a web developer I'm _not ”allowed”_ to have reservations about this. By all means, I’m excited that the line between web app and regular-schmegular app is further blurring. I’m not intending to spread FUD. I hope everything works out.
...
![Spammy Notifications in Android Control Center](/postImages/annoying-push-notis.jpeg)
...
A subpoint I couldn’t find myself fitting anywhere else is this: In the worst-case scenario where Push Notifications are exhausted as an engagement channel, what’s next for the cacophony of noise? [The Lock Screen?](https://www.glance.com) Imagine engaging your customers [directly through their brains!](https://neuralink.com)
